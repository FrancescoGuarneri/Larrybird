# Django settings for larrypy project.
...
DATABASES = {
    'default': {
        ...
        'NAME': ROOTPATH + '/data.db',          # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'larrypy.urls'

LOGIN_URL = '/signin/'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'larrypy.wsgi.application'
